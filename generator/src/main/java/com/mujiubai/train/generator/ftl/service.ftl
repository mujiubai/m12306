package com.mujiubai.train.${module}.service;
...
import com.mujiubai.train.${module}.domain.${Domain};
import com.mujiubai.train.${module}.domain.${Domain}Example;
import com.mujiubai.train.${module}.mapper.${Domain}Mapper;
