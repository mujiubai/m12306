...
import com.mujiubai.train.business.req.DailyTrainSeatQueryReq;
import com.mujiubai.train.business.req.DailyTrainSeatSaveReq;
import com.mujiubai.train.business.resp.DailyTrainSeatQueryResp;
...
public class DailyTrainSeatService {
    ...
    public PageResp<DailyTrainSeatQueryResp> queryList(DailyTrainSeatQueryReq req) {
        ...
        dailyTrainSeatExample
                .setOrderByClause("date desc, train_code asc, carriage_index asc, carriage_seat_index asc");
    ...
    public void genDaily(Date date, String trainCode) {
        ...
        String sellStr = StrUtil.fillBefore("", '0', trainStations.size() - 1);
        // 查出某车次的所有的座位信息
        ...
        for (TrainSeat trainSeat : SeatList) {
            ...
            dailyTrainSeat.setSell(sellStr);
            dailyTrainSeatMapper.insert(dailyTrainSeat);
        }
    ...
    public List<DailyTrainSeat> selectBySeat(Date date, String trainCode, int carriageIndex) {
        DailyTrainSeatExample dailyTrainSeatExample = new DailyTrainSeatExample();
        dailyTrainSeatExample
                .setOrderByClause("carriage_seat_index asc");
        dailyTrainSeatExample.createCriteria()
                .andDateEqualTo(date)
                .andTrainCodeEqualTo(trainCode)
